...
def render_sentiment(model, text):
    if text.strip():
...
def main():
    ...
    # display sentiment
    render_sentiment(model, text)

    # render suggested keywords section
    render_keywords(model, text)

    # render suggested title section
    render_title(model, text)

    # render abstract summary section
    render_summary(model, text)
